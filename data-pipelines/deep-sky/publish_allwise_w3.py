...
def cached_image(cache: Path, reference: str, level: str, ra_deg: float, dec_deg: float,
    ...
    return payload, {
        ...
        "processingServiceDoi": "10.26093/2msf-n437",
        "requestUrl": url,
...
def main() -> None:
    ...
    manifest = {
        ...
        "source": {
            ...
            "acknowledgment": "This publication makes use of data products from WISE, a joint project of UCLA and JPL/Caltech, funded by NASA, served by NASA/IPAC IRSA.",
        },
        "processing": {
            "service": "CDS hips2fits", "serviceDoi": "10.26093/2msf-n437",
