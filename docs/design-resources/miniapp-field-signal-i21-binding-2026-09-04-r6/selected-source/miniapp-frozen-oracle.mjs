...
const result = { oracle: "starward-field-signal-i21-miniapp-constraint-oracle@1.0.0", method: "asset_integrity", comparator: "asset_equal", actual, expected, pass: actual === expected };
