...
const result = { oracle: "starward-sky-canvas-miniapp-constraint-oracle@1.0.0", method: "asset_integrity", comparator: "asset_equal", actual, expected, pass: actual === expected };
