/* Experiment 1 / B / round 1. Native Figma Plugin API. Source and fixture notes: ../rationale.md.
...
async function buildDesign({ root, page, direction, width = 390, height = 844, mode = 'day', state, fonts, icons, mapImageHash, fixture = {} }) {
  ...
  root.setPluginData('designRound','1');
  ...
  if(page==='my'){
    ...
    if(direction===0){
      ...
      text(facts,'Open hours','开放时间  暂无数据',W-24,15,22);line(facts,W-24);
