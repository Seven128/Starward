...
(() => {
  ...
  function setup(root) {
    ...
    one('[data-drive-minutes]').addEventListener('input',event=>{state.draftMinutes=event.target.value;one('#drive-error').hidden=true;event.target.removeAttribute('aria-invalid');});
