...
2026-09-08 用户确认“小、中、大三个可以收工”。采用反馈13最终修正版，包含顺时针一圈及副星避开主拖尾的最后修正。生产UI/接口尚未迁移。唯一地图采用入口为[ADOPTED.md](../../ADOPTED.md)。
...
基本信息首屏隐藏章节导航，到天文边界再显现；只一级同文档章节，第二章起大标题置于卡片外。月相/气象为全宽白卡内的紧凑同类数据组，内底#FBFBFC、无框；月相亮黄/灰，每个有效最小刻度下方显示对应图标。日期目标−7/+15观测夜，以真实服务/字段可用性为边界。
