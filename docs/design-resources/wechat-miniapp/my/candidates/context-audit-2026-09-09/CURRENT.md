...
[当前390px视觉](reference/my-current-2026-09-09.png) · [已隔离的Stitch历史项目](https://stitch.withgoogle.com/projects/11944978164995734673)

当时同步的静态参考节点 `3922d43b-5cdc-46eb-8a47-bf65fc370379`；它是从当前本地页面输出并同步的截图，不是可编辑HTML节点。可编辑交互源以本目录preview和页面引用的共享资源为准。Stitch保留仍适用的生成底稿/其他状态，清理已替代稿7张；清理前源稿已归档在项目任务记录。
