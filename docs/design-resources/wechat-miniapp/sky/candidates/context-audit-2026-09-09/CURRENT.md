...
[当前390px视觉](reference/sky-current-2026-09-09.png) · Stitch 历史项目已删除（ID `13823253487989500123`）

当时同步的静态参考节点 `6a638a1d-8607-400b-894f-03c63d4961fe`；它是从当前本地页面输出并同步的截图，不是可编辑HTML节点。可编辑交互源以本目录preview和页面引用的共享资源为准。当时 Stitch 保留仍适用的生成底稿/其他状态，清理已替代稿5张；清理前源稿已归档在项目任务记录。
