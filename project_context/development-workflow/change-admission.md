...
1. Define and update the owning product/surface Context and consume root DESIGN.md plus the page-specific ADOPTED.md entries linked by the current Mini Program Screen Contracts. The 2026-09-09 adopted resources replace the old I21/page-export closures; those exports were removed from the working tree and can only be recovered from Git for explicit historical replay. Do not reactivate retired styling, bind App/Admin artifacts, or treat historical delivery-carrier hashes as current design adoption. Resource adoption and production migration remain separate.
