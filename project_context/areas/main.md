...
- Native App Tonight home answers whether the user should go, communicates uncertainty, gives a score or concise assessment, and identifies the best observing window.
...
The independent Mini Program follows Map/My and the current Mini Program Screen Contract: objective facts, private contribution states and user-authored plans. The native App Tonight, alternate-place and system-preparation responsibilities above do not create Mini Program routes, recommendation filters or fixed checklists.
...
- Principles: native App conclusion first; Mini Program facts supporting user judgment. Both preserve action continuity, evidence on demand, honest uncertainty, stable layout and outdoor accessibility.
...
- Motion is restrained and supports reduced motion. Apply DESIGN.md per-product and adopted-scope material rules, including the Mini Program My plan card; a native App material restriction does not invalidate that scoped adoption.
