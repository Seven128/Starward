...
- The two detail Context are registered on-demand in `project_context/context.toml`; this index remains the single stable Screen Contract entry and does not duplicate their platform-specific facts.
