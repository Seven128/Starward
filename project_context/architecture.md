...
- docs/design-resources/miniapp-design-system-2026-08-25-sky-canvas/: inactive prior Mini Program system snapshot plus the still-current Mini Program/Operations screen-and-interaction constraint Source, human/structured development handoffs, Fact manifests and feasibility inputs. The Mini Program constraint retains composition and interaction responsibility but cannot override the newer system's visual values; the Operations constraint remains separately scoped. No resource becomes business/data/runtime authority or production proof.
