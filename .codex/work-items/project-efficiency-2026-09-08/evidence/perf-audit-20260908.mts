...
writeFileSync(new URL('./perf-audit-20260908.json', import.meta.url), JSON.stringify({ environment: { node: process.version, data: 'synthetic spots, deterministic weather, real committed Gaia catalog, in-memory repository/cache; no remote calls' }, rows }, null, 2));
